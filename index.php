	...
	<div id="carousel-home" class="carousel slide carousel-fade"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="img/banner-welcome-1.webp" alt="Oriental Centre"
					class="d-block" style="width: 100%">
				<div class="absolute-div">
					<p>Welcome to</p>
					<h1>Namaste Pavilion Restaurant</h1>
					<p>Dine-in Restaurant And Event Centre</p>


					<div class="button">
						<a href="event" class="button-link"> <span class="label"> OUR
								SERVICES <span class="icon"> <svg class="bookNow"
...
<path fill="currentColor"
			...
			<div class="carousel-item">
				...
				<div class="absolute-div">
					...
					<div class="button">
						<a href="event" class="button-link"> <span class="label"> See Menu
...
<path fill="currentColor"
						...
						</a> <a href="event" class="button-link"> <span class="label">
...
<path fill="currentColor"
			...
			<div class="carousel-item">
				<img src="img/banner-event-1.webp"
					alt="Namaste Pavilion - Event Centre" class="d-block"
					style="width: 100%">
				<div class="absolute-div">
					<h2>
						Pavilion For <br />Your Next Event
					</h2>
					<p>Capacity ranging from 60 to 400 people</p>


					<div class="button">
						<a href="event" class="button-link"> <span class="label"> BOOK NOW
								<span class="icon"> <svg class="bookNow" fill="currentColor"
										version="1.1" xmlns="http://www.w3.org/2000/svg" width="16"
										height="16" viewBox="0 0 24 24">
<path fill="currentColor"
			...
			<div class="carousel-item">
				<img src="img/banner-buffet-1.webp"
					alt="Namaste Pavilion - Launch Buffet" class="d-block"
					style="width: 100%">
				<div class="absolute-div">
					<h2>Launch Buffet</h2>
					<p>Everyday from 11:30AM to 3:30PM</p>
...
<path fill="currentColor"
			...
			<div class="carousel-item">
				<img src="img/banner-catering-1.webp"
					alt="Namaste Pavilion - Catering" class="d-block"
					style="width: 100%">
				<div class="absolute-div">
					<h2>
						Indian & Hakka Halal <br />Catering Across GTA
					</h2>
					<p>For a party, wedding, mehendi, corporate event, or a social
						event</p>


					<div class="button">
						<a href="event" class="button-link"> <span class="label"> VIEW
								PACKAGES <span class="icon"> <svg class="bookNow"
										fill="currentColor" version="1.1"
										xmlns="http://www.w3.org/2000/svg" width="16" height="16"
										viewBox="0 0 24 24">
<path fill="currentColor"
		...
		<!-- Indicators/dots -->
		<div class="carousel-indicators top-left">
		...
		<button class="carousel-control-prev top-right" type="button"
			data-bs-target="#carousel-home" data-bs-slide="prev">
			<span class="carousel-control-prev-icon"></span>
		</button>
		<button class="carousel-control-next top-right next" type="button"
			data-bs-target="#carousel-home" data-bs-slide="next">
	...
	<div class="row mt-0 mb-2 p-2 container">
		...
		<div class="col col-sm-3">
			<table>
				<tr>
					<td class="stats-icon">	
								<svg  width="40" height="40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 256 256" enable-background="new 0 0 256 256" xml:space="preserve">
<metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
<g><g><path  fill="currentColor" d="M242.9,211.8H13.1c-1.7,0-3.1-1.4-3.1-3.1v-6.2c0-1.7,1.4-3.1,3.1-3.1h229.8c1.7,0,3.1,1.4,3.1,3.1v6.2C246,210.4,244.6,211.8,242.9,211.8L242.9,211.8z M242.9,187H13.1c-1.7,0-3.1-1.4-3.1-3.1v-6.2c0-1.7,1.4-3.1,3.1-3.1h9.3c0-49.8,34.6-91.5,81-102.5c-0.1-1-0.3-2-0.3-3c0-13.7,11.1-24.8,24.8-24.8c13.7,0,24.9,11.1,24.9,24.8c0,1-0.2,2-0.3,3c46.4,11.1,81,52.7,81,102.5h9.3c1.7,0,3.1,1.4,3.1,3.1v6.2C246,185.6,244.6,187,242.9,187L242.9,187z M128,56.6c-6.9,0-12.4,5.6-12.4,12.4c0,0.3,0.1,0.5,0.1,0.8c4-0.5,8.2-0.8,12.4-0.8s8.3,0.3,12.4,0.8c0-0.3,0.1-0.5,0.1-0.8C140.4,62.2,134.9,56.6,128,56.6L128,56.6z M128,81.5c-51.4,0-93.1,41.7-93.1,93.1h186.3C221.1,123.1,179.4,81.5,128,81.5L128,81.5z M94.4,106.1c3.2,2.7,5.7,6.2,7.2,10.2c-13.4,7.4-24.5,18.4-31.8,31.8c-4-1.5-7.5-4-10.2-7.2C67.8,126.4,79.8,114.4,94.4,106.1L94.4,106.1z"/></g></g>
</svg>
					</td>
					<td style="min-width: 170px;"><h2 class="title">Launch Buffet</h2>
						<p class="content">$18 - $25 /person</p></td>
				</tr>
			</table>
		</div>
	</div>
...
<div id="our-services" class="d-flex justify-content-center">
	<div class="row mt-0 mb-2 p-2 container">
		<h3 class="p-5 mb-0 text-center">Restaurant Special</h3>
		<div class="col col-sm-3">
			<table>
				<tr>
					<td class="stats-icon"><svg role="img" width="40" height="40"
...
<div id="offer" class="p-3 mb-4 offer">
	<div class="row">
		<div class="col events">
			<h3 class="p-4 mb-0 text-center">Our Pavilion Restaurant offers an perfect setting and dedicated service for</h3>
			<div class="row">
				<div class="col col-offer corporate p-4 fade-out-up-element">
					<span class="for">your</span>
					<h4>Corporate</h4>
...
<div id="partners" class="p-3 mb-4 partners">
	...
	<div class="row pb-5">
		<div class="col item text-center image-hover-effect">
			<a href="https://www.sumaxhomes.ca/" target="_blank"> <img
				alt="EXP Reality - Sagoon Group" src="img/partner-sagoon.jpg"
				title="EXP Reality - Sagoon Group" width="120">
			</a>
		</div>
		<div class="col item text-center image-hover-effect">
			<a href="https://vindaloocuisine.com/" target="_blank"> <img
				alt="Vindaloo Restaurant" src="img/partner-vindaloo.jpg"
				title="Vindaloo Restaurant" width="120">
			</a>
		</div>
		<div class="col item text-center image-hover-effect">
			<a
				href="https://www.facebook.com/p/BiD-CPA-Professional-Corporation-100089216624294/"
				target="_blank"> <img alt="BiD CPA Professional Corporation "
				src="img/partner-bid.jpg" title="BiD CPA Professional Corporation"
				width="120">
			</a>
		</div>
		<div class="col item text-center image-hover-effect">
			<a href="https://www.kathmandurestaurant.ca/" target="_blank"> <img
				alt="Kathmandu Restaurant" src="img/partner-ktm.jpg"
				title="Kathmandu Restaurant" width="120">
			</a>
		</div>
		<div class="col item text-center image-hover-effect">
			<a href="https://kipastories.com/" target="_blank"> <img
				alt="Kipa Stories" src="img/partner-kipa.jpg" title="Kipa Stories"
				width="120">
			</a>
		</div>
	</div>
