...
<p>We offer a variety of customizable starter and dinner menus tailored to your taste and budget. The standard package pricing below includes both <b>food</b> and <b><a href="venue">venue</a></b> rental when you choose on-site catering for your next event at our venue.</p>
		<div id="package" class="row">
			<div class="col pack-vegi">
				...
				<div class="detail">
					<p>
						<strong>TOTAL 11 ITEMS</strong>
					</p>
					<p>
						<strong>Starter</strong><br>Vegi - 3
					</p>
					<p>
						<strong>Main Course</strong><br>Carbs - 2<br>Vegi - 3<br>Pickle -
						1<br>Salad- 1
					</p>
					<p>
				...
				<div class="price">
					<p>
						<strong>Price</strong><br>20 - 25 guests: $29<br>26 - 50 guests:
						$28<br>51 - 100+ guests: $27
					</p>
				</div>
			</div>
			<div class="col pack-silver">
				...
				<div class="price">
					<p>
						<strong>Price</strong><br>20 - 25 guests: $32<br>26 - 50 guests:
						$31<br>51 - 100+ guests: $30
					</p>
				</div>
			</div>
			<div class="col pack-gold">
				<div class="title">GOLD</div>
				<div class="detail">
					<p>
						<strong>TOTAL 13 ITEMS</strong>
					</p>
					<p>
				...
				<div class="price">
					<p>
						<strong>Price</strong><br>20 - 25 guests: $37<br>26 - 50 guests:
						$36<br>51 - 100+ guests: $35
					</p>
				</div>
			</div>
			<div class="col pack-daimond">
				<div class="title">DIAMOND</div>
				<div class="detail">
					<p>
						<strong>TOTAL 19 ITEMS</strong>
					</p>
					<p>
				...
				<div class="price">
					<p>
						<strong>Price</strong><br>20 - 25 guests: $45<br>26 - 50 guests:
						$44<br>51 - 100+ guests: $43
					</p>
				</div>
			</div>
		</div>
